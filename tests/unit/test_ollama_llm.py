...
class TestOllamaChat:
    ...
    def test_chat_forwards_extra_chat_configs_to_payload_and_options(self):
        """Should merge Ollama-specific extra configs into payload/options."""
        settings = MockSettings(
            llm=MockLLMSettings(
                extra_chat_configs={
                    "format": "json",
        ...
        with patch("httpx.Client") as mock_client:
            ...
            llm.chat([Message(role="user", content="Hello")], options={"top_p": 0.7})
