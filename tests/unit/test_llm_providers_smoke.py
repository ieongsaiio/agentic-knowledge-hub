...
class TestDeepSeekLLM:
    ...
    def test_init_uses_settings_api_key_and_base_url(self):
        """Should read DeepSeek API key and base_url from settings."""
        settings = MockSettings(
            llm=MockLLMSettings(
                provider="deepseek",
                api_key="settings-key",
                base_url="https://settings.deepseek.com",
            )
        )
        ...
        assert llm.base_url == "https://settings.deepseek.com"
    ...
    def test_chat_forwards_extra_chat_configs(self):
        """Should merge settings-level and per-call extra chat configs into payload."""
        settings = MockSettings(
            llm=MockLLMSettings(
                provider="deepseek",
                extra_chat_configs={
