"""Configuration loading and validation for the Agentic Knowledge Hub."""
...
class LLMSettings:
    ...
    # Provider-specific chat completion options forwarded to the API payload.
    extra_chat_configs: Dict[str, Any] = field(default_factory=dict)
...
class RerankSettings:
    ...
    model: str
    top_k: int
    api_args: Dict[str, Any] = field(default_factory=dict)
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Settings":
        ...
        settings = cls(
            llm=LLMSettings(
                ...
                extra_chat_configs=(
                    _optional_mapping(llm, "extra_chat_configs", "llm")
                    or _optional_mapping(llm, "chat_configs", "llm")
                ),
            ),
            embedding=EmbeddingSettings(
            ...
            rerank=RerankSettings(
                ...
                api_args=_optional_mapping(rerank, "api_args", "rerank"),
            ),
            evaluation=EvaluationSettings(
