...
class Chunk:
    ...
    Attributes:
        ...
        metadata: Chunk-level metadata inherited and extended from Document:
            ...
            - page_start: First physical PDF page covered by the chunk
            - page_end: Last physical PDF page covered by the chunk
            - page_num: Physical page when page_start == page_end
